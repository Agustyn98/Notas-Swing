...
public class Carpetas {
	...
	private void initialize() {
		...
		scrollPaneCarpetas.setViewportView(listCarpetas);
				...
				listCarpetas.setFont(new Font("Open Sans", Font.BOLD, 18));
				...
				ImageIcon imageIconEntrar = new ImageIcon("C:\\Users\\agust\\Mis programas\\iconos\\green-arrow - Copy.png");		
				imageIconEntrar.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
				ImageIcon imageIconAgregar = new ImageIcon("C:\\Users\\agust\\Mis programas\\iconos\\sign-add-icon.png");		
				imageIconAgregar.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
				ImageIcon imageIconEliminar = new ImageIcon("C:\\Users\\agust\\Mis programas\\iconos\\delete-iconpng.png");		
				imageIconEliminar.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
				...
				headerPanel.setBounds(36, 11, 467, 40);
